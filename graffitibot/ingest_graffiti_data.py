...
def ingest_graffiti_last_90_days(db_path="../311_categories.db"):
    ...
    print(f"🎨 Ingesting graffiti data for service code: {service_code}")
    ...
    try:
        ...
        print(f"📊 Existing graffiti records: {existing_count:,}")
        if existing_count > 0:
        ...
        print(f"🔍 Fetching graffiti tickets from past 90 days...")
        ...
        while True:
            ...
            try:
                ...
                if not new_records:
                    print(f"   ✅ No new records on page {page}")
                    break
                ...
                print(f"   📝 Page {page}: {inserted:,} new records (total: {total_ingested:,})")
        ...
        print(f"📊 Total graffiti records: {final_count:,}")
        print(f"🆕 New records added: {newly_added:,}")
        print(f"📅 Full date range: {final_min_date} to {final_max_date}")
...
def main():
    ...
    try:
        total_ingested = ingest_graffiti_last_90_days()
